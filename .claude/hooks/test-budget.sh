...
FULL_SUITE_RE='^[[:space:]]*pnpm([[:space:]]+run)?[[:space:]]+test[[:space:]]*$|^[[:space:]]*pnpm([[:space:]]+run)?[[:space:]]+test:run[[:space:]]*$|^[[:space:]]*pnpm([[:space:]]+run)?[[:space:]]+test:e2e[[:space:]]*$|^[[:space:]]*pnpm([[:space:]]+run)?[[:space:]]+test:release-smoke[[:space:]]*$|^[[:space:]]*pytest[[:space:]]*$|^[[:space:]]*go[[:space:]]+test[[:space:]]+\./\.\.\.[[:space:]]*$|^[[:space:]]*cargo[[:space:]]+test[[:space:]]*$'
